...
console.log("🚀 [3] Attempting to load passport...");
try {
    await import("./config/passport.js");
    console.log("✅ Passport loaded successfully");
} catch (err) {
    console.error("❌ Failed to load passport:", err.message);
    console.log("⚠️ Continuing without passport (Google Auth will be disabled)");
}
console.log("🚀 [4] Passport loading complete");
...
console.log("🚀 [6] All route modules loaded");
...
console.log("🚀 [8] Security headers applied");
...
console.log("🚀 [9] Basic middleware applied");
...
console.log("🚀 [10] CORS configuration applied");

const GOOGLE_SECRET = process.env.GOOGLE_SECRET;
const isProduction = process.env.NODE_ENV === "production" || process.env.RENDER;

console.log("🚀 [11] Environment check:", {
...
console.log("🚀 [12] Starting startServer function...");

const startServer = async () => {
    console.log("🚀 [13] startServer function executed");
    try {
        ...
        if (!GOOGLE_SECRET || String(GOOGLE_SECRET).trim() === "") {
            console.error("❌ GOOGLE_SECRET is missing or empty!");
            logger.error("Server Startup Error: GOOGLE_SECRET is required (session signing)");
            process.exit(1);
        }
        console.log("✅ Environment variables validated");
        if (GOOGLE_SECRET.length < 16) {
            console.warn("⚠️ GOOGLE_SECRET should be at least 16 characters for production security");
        ...
        try {
            ...
            console.log("⚠️ Failed to connect to Redis:", redisError.message);
        ...
        if (isProduction && redisClient?.isOpen) {
            ...
            console.log("✅ Mongo session store configured (production, Redis unavailable)");
        ...
        console.log("🔄 Applying session and passport middleware...");
        app.use(session(sessionConfig));
        app.use(passport.initialize());
        app.use(passport.session());
        console.log("✅ Session and passport middleware applied");
        ...
        console.log("🔄 Initializing real-time quiz...");
...
console.log("🚀 [14] About to call startServer()");
startServer();
